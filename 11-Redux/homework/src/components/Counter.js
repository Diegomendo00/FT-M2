...
class Counter extends Component {
    ...
    incrementAsync = () => {
        //  Implementar una función de incremento que aumenta después de esperar un segundo
		  setTimeout(this.props.increment, 2000)//al momento de agregar una funcion a un setTimeOut solo se coloca la referencia de la funcion mas no se invoca, ya que sera invocada despues del tiempo establecido en el settimeout.
    };
        ...
        return (
            <p>
                ...
                <button onClick={this.props.increment}>
                    + {/* Incremeta */}{/* como estamos manejando un componente de clase, para poder acceder ya se a un estado o una funcion desde otro componente se debe utilizar el this.props*/}
                </button>
